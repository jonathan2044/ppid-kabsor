                      ...
                      <div className="bg-popover border border-popover-border rounded-md shadow-lg py-2">
                        {item.items.map((subItem) => (
                          <button
                            ...
                            className="block w-full text-left px-4 py-2 text-sm text-popover-foreground hover-elevate transition-colors"
                ...
                {item.items && item.items.length > 0 ? (
                  <>
                    ...
                    {item.items.map((subItem) => (
                      <button
                        key={subItem.label}
                        onClick={() => { setLocation(subItem.href); setMobileMenuOpen(false); }}
                        className="block w-full text-left py-2 pl-4 text-sm text-muted-foreground hover:text-foreground"
